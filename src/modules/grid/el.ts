...
const commonWords: CommonWords = {
  TWELVE: [55, 56, 57, 58, 59], // ΔΩΔΕΚΑ
  ONE: [11, 12, 13], // ΜΙΑ
  TWO: [14, 15, 16], // ΔΥΟ
  THREE: [17, 18, 19, 20], // ΤΡΕΙΣ
  FOUR: [22, 23, 24, 25, 26], // ΤΕΣΣΕΡΙΣ
  FIVE: [33, 34, 35, 36, 37], // ΠΕΝΤΕ
  SIX: [28, 29, 30, 31], // ΕΞΙ
  SEVEN: [44, 45, 46, 47], // ΕΦΤΑ
  EIGHT: [38, 39, 40, 41], // ΟΧΤΩ
  NINE: [60, 61, 62, 63], // ΕΝΝΙΑ
  TEN: [66, 67, 68, 69], // ΔΕΚΑ
  ELEVEN: [48, 49, 50, 51, 52, 53], // ΕΝΤΕΚΑ
  FIVE_MIN: [104, 105, 106, 107, 108], // ΠΕΝΤΕ
  TEN_MIN: [88, 89, 90, 91], // ΔΕΚΑ
  QUARTER_MIN: [81, 82, 83, 84, 85, 86], // ΤΕΤΑΡΤΟ
  TWENTY_MIN: [88, 89, 90, 91, 92], // ΕΙΚΟΣΙ
  TWENTYFIVE_MIN: [99, 100, 101, 102, 103], // ΜΙΣΗ
...
const localeWords = {
  ...
  ΠΑΡΑ: [69, 70, 71, 72], // ΠΑΡΑ (Before/To)
