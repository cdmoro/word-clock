...
const commonWords: CommonWords = {
  ...
  FIVE_MIN: [8, 9, 10], // FÜF
  TEN_MIN: [11, 12, 13], // ZÄÄ
  QUARTER_MIN: [15, 16, 17, 18, 19], // VIERTU
  TWENTY_MIN: [22, 23, 24, 25, 26], // ZWÄNZG
  TWENTYFIVE_MIN: [
    // [0, 1, 2, 3], // FÜF
    [22, 23, 24, 25, 26], // ZWÄNZG
  ],
  HALF: [36, 37, 38, 39], // HAUBI
};
...
export default {
  ...
  examples: {
    ...
    // '01:25': 'ES ISCH FÜF VOR HAUBI ZWÖI', // 25 past 1
    // '01:30': 'ES ISCH HAUBI ZWÖI', // Half-past 1
    // '01:35': 'ES ISCH FÜF AB HAUBI ZWÖI', // 5 past half 2
    ...
    // '17:05': 'ES ISCH FÜF AB FÜFI', // 5 past 5
    // '20:26': 'ES ISCH FÜF VOR HAUBI ACHTI', // 5 before half-past 8
  },
